...
CREATE INDEX client_key_group_room_index ON client (id, groupId, currentRoomId);
CREATE INDEX client_key_index ON client (id);
CREATE INDEX waitlist_key_client_shelter_index ON waitlist (id, shelterId, clientId);
CREATE INDEX waitlist_key_index ON waitlist (id);
CREATE INDEX shelter_key_address_index ON shelter (id, addressId);
CREATE INDEX shelter_key_index ON shelter (id);
CREATE INDEX shelterServiceJunction_index ON shelterServiceJunction (shelterId, serviceId);
CREATE INDEX address_zip_index ON address (zip);